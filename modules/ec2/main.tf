...
resource "null_resource" "ansible-pull" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      "ansible-pull -i localhost, -U https://github.com/sbakkolla549/roboshop-ansible roboshop.yml -e env=${var.env} -e component=${var.component_name} -e vault_token=${var.vault_token}"
    ]
  }
}
